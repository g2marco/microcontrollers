...
ANSEL equ 09Fh ;# 
	...
	FNCALL	_loop,_debounce_input_XXX
	FNROOT	_main
	FNCALL	intlevel1,_general_isr
	global	intlevel1
	FNROOT	intlevel1
	global	_ticks_XXX
	global	_isDebouncing_XXX
	global	_tick
	global	_debounced_XXX
	global	_TMR2
_TMR2	set	0x11
	global	_T2CON
_T2CON	set	0x12
...
;; *************** function _loop *****************
;; Defined at:
;;		line 41 in file "..\src\app_main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
l731:	
	fcall	_debounce_input_XXX
	line	45
	
l733:	
	btfsc	(_debounced_XXX/8),(_debounced_XXX)&7
	goto	u81
	goto	u80
...
GLOBAL	__end_of_loop
	__end_of_loop:
	signat	_loop,89
	global	_debounce_input_XXX

;; *************** function _debounce_input_XXX *****************
;; Defined at:
;;		line 25 in file "..\src\app_main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
psect	text5,local,class=CODE,delta=2,merge=1,group=0
	line	25
global __ptext5
__ptext5:	;psect for function _debounce_input_XXX
psect	text5
	file	"..\src\app_main.c"
	line	25
	global	__size_of_debounce_input_XXX
	__size_of_debounce_input_XXX	equ	__end_of_debounce_input_XXX-_debounce_input_XXX
	
_debounce_input_XXX:	
;incstack = 0
	callstack 5
; Regs used in _debounce_input_XXX: [wreg+status,2+status,0]
	line	26
	
l685:	
	movf	((_isDebouncing_XXX)),w
	btfsc	status,2
	goto	u11
	goto	u10
u11:
...
l689:	
	bcf	(_debounced_XXX/8),(_debounced_XXX)&7
	bcf	status, 5	;RP0=0, select bank0
	btfss	(41/8),(41)&7	;volatile
	goto	u35
	bsf	(_debounced_XXX/8),(_debounced_XXX)&7
u35:

	line	30
	
l691:	
	clrf	(_isDebouncing_XXX)
	goto	l43
	line	33
...
u50:
	movlw	0
u52:
	xorwf	(??_debounce_input_XXX+0)+0,w
	skipnz
	goto	u61
	goto	u60
u61:
...
l695:	
	movlw	low(064h)
	movwf	(??_debounce_input_XXX+0)+0
	movf	(??_debounce_input_XXX+0)+0,w
	movwf	(_ticks_XXX)
	line	35
	
l697:	
	clrf	(_isDebouncing_XXX)
	incf	(_isDebouncing_XXX),f
	line	38
	
l43:	
	return
	callstack 0
GLOBAL	__end_of_debounce_input_XXX
	__end_of_debounce_input_XXX:
	signat	_debounce_input_XXX,89
	global	_interruptions

;; *************** function _interruptions *****************
;; Defined at:
;;		line 28 in file "..\src\libs\device_setup.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
psect	text6,local,class=CODE,delta=2,merge=1,group=0
	...
	line	28
global __ptext6
__ptext6:	;psect for function _interruptions
psect	text6
	file	"..\src\libs\device_setup.c"
	line	28
...
;; Defined at:
;;		line 13 in file "..\src\app_main.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
psect	text7,local,class=CODE,delta=2,merge=1,group=0
	...
	line	13
global __ptext7
__ptext7:	;psect for function _general_isr
psect	text7
	file	"..\src\app_main.c"
	line	13
